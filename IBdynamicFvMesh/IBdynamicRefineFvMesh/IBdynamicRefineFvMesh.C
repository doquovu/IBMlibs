...
#include "IBdynamicRefineFvMesh.H"
...
namespace Foam
{
    defineTypeNameAndDebug(IBdynamicRefineFvMesh, 0);
    addToRunTimeSelectionTable(IBdynamicFvMesh, IBdynamicRefineFvMesh, IOobject);
}

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

Foam::label Foam::IBdynamicRefineFvMesh::count
(
...
void Foam::IBdynamicRefineFvMesh::calculateProtectedCells
(
...
void Foam::IBdynamicRefineFvMesh::readDict()
{
...
Foam::IBdynamicRefineFvMesh::refine
(
...
Foam::autoPtr<Foam::mapPolyMesh>
Foam::IBdynamicRefineFvMesh::unrefine
(
...
Foam::scalarField
Foam::IBdynamicRefineFvMesh::maxPointField(const scalarField& pFld) const
{
...
Foam::scalarField
Foam::IBdynamicRefineFvMesh::maxCellField(const volScalarField& vFld) const
{
...
Foam::scalarField
Foam::IBdynamicRefineFvMesh::cellToPoint(const scalarField& vFld) const
{
...
Foam::scalarField Foam::IBdynamicRefineFvMesh::error
(
...
void Foam::IBdynamicRefineFvMesh::selectRefineCandidates
(
...
Foam::labelList Foam::IBdynamicRefineFvMesh::selectRefineCells
(
...
Foam::labelList Foam::IBdynamicRefineFvMesh::selectUnrefinePoints
(
...
void Foam::IBdynamicRefineFvMesh::extendMarkedCells
(
...
void Foam::IBdynamicRefineFvMesh::checkEightAnchorPoints
(
...
Foam::IBdynamicRefineFvMesh::IBdynamicRefineFvMesh(const IOobject& io)
:
    IBdynamicFvMesh(io),
    meshCutter_(*this),
    dumpLevel_(false),
...
Foam::IBdynamicRefineFvMesh::~IBdynamicRefineFvMesh()
{}
...
bool Foam::IBdynamicRefineFvMesh::update(const labelList& neighbourCells)
{
    ...
    Info<<"Read data form dynamicMeshDict dictionary"<<nl<<endl;
    dictionary refineDict
    (
        IOdictionary
        (
    ...
    if (time().timeIndex() > 0 && time().timeIndex() % refineInterval == 0)
    {
        ...
        {
            refineCell.set(neighbourCells[celli], 1);
        }
        // Determine candidates for refinement (looking at field only)
        // selectRefineCandidates
        // (
...
bool Foam::IBdynamicRefineFvMesh::writeObject
(
...
) const
{
    ...
    bool writeOk =
    (
        IBdynamicFvMesh::writeObject(fmt, ver, cmp, valid)
